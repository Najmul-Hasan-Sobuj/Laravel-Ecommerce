                            ...
                            <div class="row">
                                <div class="col-lg-8 offset-lg-2">
                                    <div class="card mt-3">
                                        <div class="card-body">
                                            <form
                                                action="{{ route('provider.categories.childCategory.update', [$childCategorys->id]) }}"
                                                    ...
                                                    <select name="category_id" data-placeholder="Select your category name"
                                                        ...
                                                        @foreach ($categorys as $category)
                                                            <option value="{{ $category->id }}"
                                                                @if ($category->id == $childCategorys->category_id) selected @endif>
                                                    ...
                                                    <select name="sub_category_id"
                                                        ...
                                                        @foreach ($subCategorys as $subCategory)
                                                            <option value="{{ $subCategory->id }}"
                                                                @if ($subCategory->id == $childCategorys->sub_category_id) selected @endif>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="child_category_name"
                                                        ...
                                                        placeholder="Bat" value="{{ $childCategorys->child_category_name }}"
                                                        required>
                                                </div>
                                                <div class="text-end">
                                                    <button type="reset" class="btn btn-danger">Reset<i
                                                            class="icon-reset"></i></button>
                                                    <a href="{{ route('provider.categories.childCategory.index') }}"
