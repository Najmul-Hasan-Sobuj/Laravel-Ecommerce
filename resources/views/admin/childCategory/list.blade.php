            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 float-start">Child Category Table</h5>
                    </div>

                    <div class="table-responsive">
                        <table id="childCategoryTable" class="table table-bordered table-striped table-hover"
                            style="width:100%">
                            <thead>
                                <tr>
                                    <th width="5%">#</th>
                            ...
                            <tbody>
                                {{-- data load from child category table --}}
                            </tbody>
                        </table>
                    </div>
                </div>
    ...
    @once
        <script type="text/javascript">
            $(function childCategory() {
                var table = $('#childCategoryTable').DataTable({
                    processing: false,
                    // searching: true,
                    // bPaginate: true,
                    // paging: true,
                    ...
                    // info: true,
                    serverSide: true,
                    ajax: "{{ route('provider.categories.childCategory.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex'
                        },
