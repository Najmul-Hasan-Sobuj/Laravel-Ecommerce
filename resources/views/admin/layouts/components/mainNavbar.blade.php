    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand flex-1 flex-lg-0">
            <a href="index.html" class="d-inline-flex align-items-center">
                ...
                <img src="{{ asset('backend/images/logo_text_light.svg') }}"
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-0">
                        <div class="col">
                            <button type="button"
                                ...
                                <div>
                                    <img src="{{ asset('backend/images/demo/logos/1.svg') }}" class="h-40px mb-2"
                                        alt="">
                        ...
                        <div class="col">
                            <button type="button"
                                ...
                                <div>
                                    <img src="{{ asset('backend/images/demo/logos/2.svg') }}" class="h-40px mb-2"
                                        alt="">
                        ...
                        <div class="col">
                            <button type="button"
                                ...
                                <div>
                                    <img src="{{ asset('backend/images/demo/logos/3.svg') }}" class="h-40px mb-2"
                                        alt="">
                        ...
                        <div class="col">
                            <button type="button"
                                ...
                                <div>
                                    <img src="{{ asset('backend/images/demo/logos/4.svg') }}" class="h-40px mb-2"
                                        alt="">
                ...
                <div class="form-control-feedback form-control-feedback-start flex-grow-1" data-color-theme="dark">
                    ...
                    <div class="dropdown-menu w-100" data-color-theme="light">
                        ...
                        <div class="dropdown-menu-scrollable-lg">
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="{{ asset('backend/images/brands/adobe.svg') }}"
                                        class="w-32px h-32px rounded-pill" alt="">
                                </div>
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="{{ asset('backend/images/brands/holiday-inn.svg') }}"
                                        class="w-32px h-32px rounded-pill" alt="">
                                </div>
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="{{ asset('backend/images/brands/ing.svg') }}"
                                        class="w-32px h-32px rounded-pill" alt="">
                                </div>
