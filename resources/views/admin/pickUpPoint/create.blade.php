            ...
            <div class="content">
                <div class="card">
                    <div class="card-header d-sm-flex align-items-sm-center">
                        <h6 class="mb-sm-0">Pick-Up Point Create Form</h6>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-8 offset-lg-2">
                                    <div class="card mt-3">
                                        <div class="card-body">
                                            <form action="{{ route('provider.pickUpPoint.store') }}" method="POST"
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea id="address" name="address" rows="2" cols="3" maxlength="150"
                                                        class="form-control maxlength-textarea" placeholder="This textarea has a limit of 225 chars."></textarea>
                                                </div>
