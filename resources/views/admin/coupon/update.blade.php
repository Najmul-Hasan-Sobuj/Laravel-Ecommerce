            ...
            <div class="content">
                <div class="card">
                    <div class="card-header d-sm-flex align-items-sm-center">
                        <h6 class="mb-sm-0">Coupon Update Form</h6>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-8 offset-lg-2">
                                    <div class="card mt-3">
                                        <div class="card-body">
                                            <form action="{{ route('provider.coupon.update', [$coupon->id]) }}"
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" id="coupon_code" name="coupon_code"
                                                        ...
                                                        value="{{ $coupon->coupon_code }}" maxlength="10"
                                                        placeholder="Enter Your Coupon Code" required>
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label">Valid Date:<span
                                                            class="text-danger">*</span></label>
                                                    <input type="date" id="valid_date" value="{{ $coupon->valid_date }}"
                                                        name="valid_date"
